...
class MedleyDBDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        class_label = audio_filename.split('/')[-1].split('_')[1].split('-')[-1]
        return {'audio': signal[0], 'label': int(class_label)}
...
class MedleyDBDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.data_train = MedleyDBDataset(self.hparams.data_dir, ['train', 'test'])
        self.data_val = MedleyDBDataset(self.hparams.data_dir, ['validation'])
        self.data_test = MedleyDBDataset(self.hparams.data_dir, ['validation'])
